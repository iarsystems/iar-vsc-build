...
suite("Test C-STAT", ()=>{
    ...
    const expectedDiagnostics: Vscode.Diagnostic[] = [
        ...
        { message: "Variable `arr' is only used once", source: "MISRAC++2008-0-1-4_a [Low]", severity: Vscode.DiagnosticSeverity.Warning, range: makeRange(25, 10) },
        ...
        { message: "Implicit conversion of `a' from essential type signed 32-bit int to different or narrower essential type character", source: "MISRAC2012-Rule-10.3 [Medium]", severity: Vscode.DiagnosticSeverity.Warning, range: makeRange(26, 14) },
        { message: "Function call `bad_fun()' is immediately dereferenced, without checking for NULL", source: "PTR-null-fun-pos [High]", severity: Vscode.DiagnosticSeverity.Warning, range: makeRange(23, 18) },
        { message: "Array `arr' 1st subscript 4 is out of bounds [0,3]", source: "ARR-inv-index,MISRAC++2008-5-0-16_c,MISRAC2012-Rule-18.1_a,CERT-ARR30-C_a [High]", severity: Vscode.DiagnosticSeverity.Warning, range: makeRange(26, 8) },
        ...
        { message: "A // style comment", source: "MISRAC2004-2.2 [Low]", severity: Vscode.DiagnosticSeverity.Warning, range: makeRange(24, 5) },
