...
/* Check the parameters */
  ...
  assert_param(IS_LTDC_VCONFIGST(LTDC_Layer_InitStruct->LTDC_VarticalStart));
  ...
  LTDC_Layerx->WVPCR  = (LTDC_Layer_InitStruct->LTDC_VarticalStart | wvsppos);
...
void LTDC_LayerStructInit(LTDC_Layer_InitTypeDef * LTDC_Layer_InitStruct)
{
  ...
  LTDC_Layer_InitStruct->LTDC_VarticalStart = 0x00;
