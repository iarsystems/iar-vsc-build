...
suite("Test C-STAT", () => {
    ...
    const generateExpectedDiagnostics: () => Vscode.Diagnostic[] = () => [
        ...
        { message: "Externally-linked object or function `addOne' is referenced in only one translation unit", code: "MISRAC2004-8.10 [Low]", severity: Vscode.DiagnosticSeverity.Warning, range: makeRange(17, 11), relatedInformation: [] },
