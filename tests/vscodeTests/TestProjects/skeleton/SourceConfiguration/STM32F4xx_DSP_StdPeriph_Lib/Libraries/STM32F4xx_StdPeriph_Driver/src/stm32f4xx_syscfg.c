...
/**
  ...
  *            @arg SYSCFG_MemoryRemap_FSMC:        FSMC (Bank1 (NOR/PSRAM 1 and 2) mapped at 0x00000000 for STM32F40xx/41xx and STM32F427x/437x devices. 
  *            @arg SYSCFG_MemoryRemap_FMC:         FMC (Bank1 (NOR/PSRAM 1 and 2) mapped at 0x00000000 for STM32F429x/439x devices.  
  *            @arg SYSCFG_MemoryRemap_SRAM:        Embedded SRAM (112kB) mapped at 0x00000000
  *            @arg SYSCFG_MemoryRemap_SDRAM:       FMC (External SDRAM)  mapped at 0x00000000 for STM32F429x/439x devices.            
  * @retval None
  */
...
/**
  ...
  *          EXTI lines where x can be (A..K) for STM32F429x/439x devices or (A..I) 
  *          for STM32F40xx/STM32F41xx and STM32F427x/STM32F437x devices.
  *            
  * @param  EXTI_PinSourcex: specifies the EXTI line to be configured.
  *           This parameter can be EXTI_PinSourcex where x can be (0..15, except
  *           for EXTI_PortSourceGPIOI x can be (0..11) for STM32F40xx/STM32F41xx 
  *           and STM32F427x/STM32F437x devices and for EXTI_PortSourceGPIOK x can   
  *           be (0..7) for STM32F429x/STM32F439x devices. 
  *             
  * @retval None
  */
