...
@verbatim   
 ...
 |---------------|----------------|----------------|-----------------|-----------------| 
 |8WS(9CPU cycle)|      NA        |      NA        |        NA       |160 < HCLK <= 168|
 +-------------------------------------------------------------------------------------+ 
 ...
 +-------------------------------------------------------------------------------------------------------------------+  
      ...
      -@- On STM32F40xx/41xx devices: 
          ...
          [..] 
          On STM32F427x/437x and STM32F429x/439x devices:
...
/**
  ...
  *          For STM32F429x/439x devices this parameter can be a value between 
 ...
 ===============================================================================   
    [..]
      ...
      (+) FLASH_Status FLASH_ProgramByte(uint32_t Address, uint8_t Data)
          The following functions can be used only for STM32F429X device. 
...
/**
  ...
  *          For STM32F40XX device this parameter can be a value between FLASH_Sector_0 
  *          and FLASH_Sector_11.
  *          For STM32F427X and STM32F429X devices this parameter can be a value between 
...
#if defined (STM32F427X) || defined (STM32F429X)    
    FLASH->CR &= CR_PSIZE_MASK;
    FLASH->CR |= tmp_psize;
...
/**
  ...
  *         the erase operation is performed before the program one.
  * @note   This function can be used only for STM32F429x/439x devices.  
  *  
  * @param  VoltageRange: The device voltage range which defines the erase parallelism.  
  *          This parameter can be one of the following values:
  *            @arg VoltageRange_1: when the device voltage range is 1.8V to 2.1V, 
...
@verbatim   
 ...
 ===============================================================================  
    ...
    [..]  
      The following function can be used only for STM32F429X device. 
...
/**
  ...
  *         1 Mb of the Flash  
  *           
  * @note   This function can be used only for STM32F427x/437x and STM32F429x/439x devices.
...
/**
  ...
  *          This parameter can be one of the following values:
  *            @arg OB_PCROP: A value between OB_PCROP_Sector0 and OB_PCROP_Sector11
...
/**
  ...
  * @note   This function can be used only for STM32F429x/439x device.
  *      
...
/**
  ...
  *            @arg FLASH_FLAG_RDERR: FLASH (PCROP) Read Protection error flag (STM32F429x/439x devices) 
...
/**
  ...
  *            @arg FLASH_FLAG_PGPERR: FLASH Programming Parallelism error flag
  *            @arg FLASH_FLAG_PGSERR: FLASH Programming Sequence error flag
  *            @arg FLASH_FLAG_RDERR: FLASH Read Protection error flag (STM32F429x/439x devices)  
  * @retval None
  */
